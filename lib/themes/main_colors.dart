...
const kPrimaryColor = Color.fromARGB(175, 87, 201, 190);
const kPrimaryColorBrighter = Color.fromARGB(255, 188, 255, 248);
const kPrimaryColorDarker = Color(0xFF196B52);
const kSecondaryColor = Color.fromARGB(200, 175, 89, 190);
